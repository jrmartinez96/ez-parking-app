...
void initCreditCardsDependencies(GetIt sl) {
  sl
    // BLoCs
    ..registerFactory(() => CreditCardsCubit(getCreditCardsUC: sl()))
    ..registerFactory(() => CreateCreditCardCubit(createCreditCardUC: sl()))
    ..registerFactory(() => EditCreditCardCubit(updateCreditCardById: sl(), deleteCreditCardById: sl()))
    // use cases
